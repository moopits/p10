...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // Passage de la newValue en paramète de onChange
    setValue(newValue);
    setCollapsed(true); // Passage de setCollapsed à true pour refermer automatiquement le select
  };
  return (
